...
#this calculates the mean of a particular instance
...
#assigns a point to a cluster by assigning it to the neaest centroid
...
def createEmptyListOfLists(numSubLists):
    myList = []
    #print "**", numSubLists   #numsublist is the k value
...
#compute the distace of each point from it`s respective centroids, i..e deviation in a way
...
dataset = loadCSV("./GHIJ-nooutliers")
